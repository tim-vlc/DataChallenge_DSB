...
def _add_weather_data(X):
    ...
    return X.drop(columns=["date", "counter_id", "site_id", "site_name", 
...
def get_estimator():
    ...
    categorical_cols = ["holidays", "france_stay_at_home", "year"]
    gap_cols = ["counter_name"]
    ...
    preprocessor = ColumnTransformer(
        [
            ...
            ("gap", GapEncoder(n_components=7, random_state=0), gap_cols),
    ...
    regressor = CatBoostRegressor(depth=10, learning_rate=0.0313796992930692, subsample=0.5429847573086735,
                                  colsample_bylevel=0.11416098413167644, min_data_in_leaf=66, grow_policy='Depthwise',
                                  random_state=1)
